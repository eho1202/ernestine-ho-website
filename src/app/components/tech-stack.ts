    ...
    <section id="tech" class="min-h-screen flex items-center justify-center bg-base-200 p-10 md:p-20">
        <div class="container mx-auto">
            ...
            <div class="pl-6 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-8 mb-20">
                ...
                <app-tech-card icon="svelte_logo" name="Svelte"></app-tech-card>
                ...
                <app-tech-card icon="azure_logo" name="Azure"></app-tech-card>
                <app-tech-card icon="openai_logo" name="OpenAI API"></app-tech-card>
                ...
                <app-tech-card icon="appium_logo" name="Appium"></app-tech-card>
            </div>
