...
@Component({
  ...
  template: `
    <section id="about" class="min-h-screen flex items-center justify-center bg-base pt-28 sm:pt-20 p-10 md:p-20 overflow-x: hidden;">
      <div class="container mx-auto flex flex-col lg:flex-row items-center lg:items-start">
        ...
        <div class="flex-1 text-center items-center justify-center sm:text-left">
          ...
          <div class="space-y-6">
            ...
            <p>
              I am passionate about <b>software development</b>, <b>data science</b>, and advancing AI technologies to make our day to day life a little less mundane!
            </p>
